...
function main() {
    ...
    console.log('[4] Filling bootstrap...');
    let tpl = fs.readFileSync('agent/bootstrap.js', 'utf8');

    ['__KEY_HEX__', '__IV_HEX__', '__DATA_B64__', '__PLAIN_SIZE__'].forEach(function (ph) {
        if (tpl.indexOf(ph) === -1) throw new Error('Missing placeholder: ' + ph);
    });
